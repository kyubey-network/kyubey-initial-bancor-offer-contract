(module
 ...
 (data (i32.const 1488) "Invalid token transfer\00")
 (data (i32.const 1520) "buy\00")
 (data (i32.const 1536) "for\00")
 (data (i32.const 1552) "eosio.token\00")
 (data (i32.const 1568) "transfer\00")
 (data (i32.const 1584) "minakokojima\00")
 (data (i32.const 1600) "Unknown deposit.\00")
 (data (i32.const 1632) "only EOS token is allowed\00")
 (data (i32.const 1664) "must buy a positive amount\00")
