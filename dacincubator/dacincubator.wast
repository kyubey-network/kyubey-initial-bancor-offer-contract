(module
 ...
 (data (i32.const 1680) "minakokojima\00")
 (data (i32.const 1696) "Unknown deposit.\00")
 (data (i32.const 1728) "only EOS token is allowed\00")
 (data (i32.const 1760) "must buy a positive amount\00")
